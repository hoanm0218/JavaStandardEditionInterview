...
class Test {
	void readAFileAndParse() throws com.hoanm.exception.RuntimeExceptionExample {
...
class Reuse {
	void doSomething() {
		com.hoanm.exception.Test test = new com.hoanm.exception.Test();
...
class CheckedException2 extends com.hoanm.exception.CheckedException1 {
}

class UnCheckedException extends RuntimeException {
}

class UnCheckedException2 extends com.hoanm.exception.UnCheckedException {
}
...
public class ExceptionHandlingExample1 {
	...
	private static void method2() {
		com.hoanm.exception.Connection connection = new com.hoanm.exception.Connection();
		connection.open();
		try {
			return;
		} catch (Exception e) {
...
// at
// com.rithus.exception.ExceptionHandlingExample1.method2(ExceptionHandlingExample1.java:33)
// at
// com.rithus.exception.ExceptionHandlingExample1.method1(ExceptionHandlingExample1.java:22)
// at
// com.rithus.exception.ExceptionHandlingExample1.main(ExceptionHandlingExample1.java:17)
